<template>
  <div id="player">
    <header is="Header" :bgStyle="music.picture">
      ...
      <img src="../assets/images/cm2_btm_tab_icn_share.png" @click="ChangePlayerShow" slot="header-right"/>
    </header>
    <article @click="handleHideList">
      ...
      <div class="controls">
        <div class="controls-top">
          ...
          <i class="controls-top-bottons" :src="music.url">
            <a :download="music.url">
    ...
    <audio :src="music.url" :autoplay="autoPlay" ref="audio" :loop="ruleToPlay===0" @play="startTurnAround" @pause="pauseTurnAround" @timeupdate="currentTimeChange" @canplay="updateDuration" @ended="handleClickToPlayNext"></audio>
  </div>
</template>
<script>
  ...
  methods: {
    ...
    handleClickToChangeCollect() {
      if (!this.collect) {
        ...
        this.$store.dispatch("moveOut", this.music.sid);
      }
    },
